...
//密码服务
    Route::any('teacherpass','PassController/teacher');
    Route::any('tpupdt','PassController/updateTeacherPass');
    Route::any('studentpass','PassController/student');
    Route::any('stupdt','PassController/updateStuPass');
});
